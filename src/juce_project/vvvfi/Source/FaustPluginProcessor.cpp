...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = (0.00390625f / fConst0);
		fConst2 = (0.0078125f / fConst0);
		fConst3 = (0.25f / fConst0);
		fConst4 = (1.0f / std::tan((6.28318548f / fConst0)));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Sync", &fHslider2, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fButton0, "1", "");
		ui_interface->addButton("gate", &fButton0);
		ui_interface->declare(&fHslider7, "2", "");
		ui_interface->addHorizontalSlider("freq", &fHslider7, 440.0f, 1.0f, 4000.0f, 1.0f);
		ui_interface->declare(&fHslider8, "3", "");
		ui_interface->addHorizontalSlider("Bend", &fHslider8, 0.0f, -12.0f, 12.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openHorizontalBox("Control");
		ui_interface->declare(0, "0", "");
		ui_interface->openVerticalBox("Oscillator");
		ui_interface->declare(&fHslider3, "0", "");
		ui_interface->declare(&fHslider3, "unit", "%");
		ui_interface->addHorizontalSlider("Pulse Extend", &fHslider3, 0.0f, 0.0f, 100.0f, 0.100000001f);
		ui_interface->declare(&fHslider4, "1", "");
		ui_interface->declare(&fHslider4, "unit", "P");
		ui_interface->addHorizontalSlider("Pulse Mode", &fHslider4, 1.0f, 1.0f, 57.0f, 2.0f);
		ui_interface->declare(&fHslider6, "2", "");
		ui_interface->addHorizontalSlider("Mod Freq", &fHslider6, 0.0f, 0.0f, 100.0f, 0.100000001f);
		ui_interface->declare(&fHslider1, "3", "");
		ui_interface->declare(&fHslider1, "unit", "%");
		ui_interface->addHorizontalSlider("Mod Level", &fHslider1, 0.0f, 0.0f, 200.0f, 0.100000001f);
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openVerticalBox("Options");
		ui_interface->declare(&fHslider9, "0", "");
		ui_interface->addHorizontalSlider("Spectrum Spread", &fHslider9, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fHslider10, "1", "");
		ui_interface->declare(&fHslider10, "unit", "%");
		ui_interface->addHorizontalSlider("Random Mod", &fHslider10, 0.0f, 0.0f, 100.0f, 0.100000001f);
		ui_interface->declare(&fHslider5, "2", "");
		ui_interface->addHorizontalSlider("High Freq Position", &fHslider5, 0.0f, 0.0f, 2.0f, 1.0f);
		ui_interface->declare(&fHslider0, "3", "");
		ui_interface->addHorizontalSlider("Pulse Level", &fHslider0, 2.0f, 2.0f, 3.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->declare(&fVslider0, "2", "");
		ui_interface->declare(&fVslider0, "unit", "%");
		ui_interface->addVerticalSlider("Gain", &fVslider0, 50.0f, 0.0f, 100.0f, 0.100000001f);
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow0 = (0.00249999994f * (float(fVslider0) * float(fButton0)));
		float fSlow1 = float(fHslider0);
		float fSlow2 = float(fHslider2);
		float fSlow3 = (mydsp_faustpower2_f((0.00999999978f * float(fHslider1))) * ((fSlow1 + (2.0f * (fSlow2 * (fSlow1 + -2.0f)))) + -1.0f));
		float fSlow4 = float(fHslider4);
		float fSlow5 = (0.00499999989f * (float(fHslider3) / fSlow4));
		int iSlow6 = int(fSlow2);
		float fSlow7 = float(fHslider5);
		float fSlow8 = float(fHslider6);
		float fSlow9 = float(fHslider7);
		float fSlow10 = (iSlow6 ? (0.125f * fSlow9) : 128.0f);
		float fSlow11 = ((fConst1 * fSlow8) * fSlow10);
		float fSlow12 = ((fConst2 * fSlow8) * fSlow10);
		int iSlow13 = (fSlow7 > 0.0f);
		float fSlow14 = (iSlow6 ? ((fSlow8 * fSlow4) * fSlow10) : (128.0f * (fSlow9 * std::pow(2.0f, (0.0833333358f * float(fHslider8))))));
		float fSlow15 = ((fConst1 / (3.0f - fSlow7)) * fSlow14);
		float fSlow16 = (fSlow1 + -1.0f);
		float fSlow17 = (iSlow13 ? 0.5f : 1.0f);
		float fSlow18 = (1.0f - fSlow2);
		float fSlow19 = (float(fHslider9) * fSlow18);
		float fSlow20 = ((fConst3 * fSlow8) * fSlow10);
		float fSlow21 = (float(fHslider10) * fSlow18);
		for (int i = 0; (i < count); i = (i + 1)) {
			fVec0[0] = fSlow7;
			float fTemp0 = (fRec1[1] + fSlow11);
			fRec1[0] = (fTemp0 - std::floor(fTemp0));
			int iTemp1 = (fRec1[0] > 0.5f);
			iVec1[0] = iTemp1;
			float fTemp2 = float((iSlow6 ? (iTemp1 == iVec1[1]) : (fSlow7 == fVec0[1])));
			fRec0[0] = (((fRec0[1] - std::floor(fRec0[1])) * fTemp2) + fSlow12);
			fRec2[0] = ((fTemp2 * (fRec2[1] - std::floor(fRec2[1]))) + fSlow15);
			float fTemp3 = (iSlow13 ? std::sin((6.28318548f * (fRec2[0] + 0.125f))) : 1.0f);
			float fTemp4 = (fRec5[1] + fSlow20);
			fRec5[0] = (fTemp4 - std::floor(fTemp4));
			fRec3[0] = ((fTemp2 * (fRec3[1] - std::floor(fRec3[1]))) + (fConst2 * (fSlow17 * (fSlow14 + (fSlow19 * float((1000 * ((2 * (ftbl0mydspSIG0[int((65536.0f * fRec5[0]))] > 0.0f)) + -1))))))));
			iRec7[0] = (1103515245 * (iRec7[1] + 12345));
			float fTemp5 = float(iRec7[0]);
			fVec2[0] = fTemp5;
			fRec6[0] = (fConst5 * ((8.06548994e-10f * (fTemp5 + fVec2[1])) - (fConst6 * fRec6[1])));
			float fTemp6 = (fSlow16 * std::sin((6.28318548f * (fRec3[0] + (fSlow21 * fRec6[0])))));
			float fTemp7 = ((fSlow3 * (std::sin((6.28318548f * (fSlow5 + (fRec0[0] + 0.333333343f)))) * fTemp3)) + fTemp6);
			float fTemp8 = (fSlow1 + (fTemp7 + -2.0f));
			float fTemp9 = ((fTemp7 + 2.0f) - fSlow1);
			float fTemp10 = (fTemp6 + (fSlow3 * (fTemp3 * std::sin((6.28318548f * (fSlow5 + (fRec0[0] + 0.666666687f)))))));
			float fTemp11 = (fSlow1 + (fTemp10 + -2.0f));
			float fTemp12 = ((fTemp10 + 2.0f) - fSlow1);
			float fTemp13 = (fSlow0 * (float((((fTemp8 > 0.0f) + (fTemp9 > 0.0f)) - ((fTemp8 < 0.0f) + (fTemp9 < 0.0f)))) - float((((fTemp11 > 0.0f) + (fTemp12 > 0.0f)) - ((fTemp11 < 0.0f) + (fTemp12 < 0.0f))))));
	...
	FAUST_ADDHORIZONTALSLIDER("[0]General/Sync", fHslider2, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDBUTTON("[0]General/gate", fButton0);
	FAUST_ADDHORIZONTALSLIDER("[0]General/freq", fHslider7, 440.0f, 1.0f, 4000.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("[0]General/Bend", fHslider8, 0.0f, -12.0f, 12.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("[1]Control/[0]Oscillator/Pulse Extend", fHslider3, 0.0f, 0.0f, 100.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("[1]Control/[0]Oscillator/Pulse Mode", fHslider4, 1.0f, 1.0f, 57.0f, 2.0f);
	FAUST_ADDHORIZONTALSLIDER("[1]Control/[0]Oscillator/Mod Freq", fHslider6, 0.0f, 0.0f, 100.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("[1]Control/[0]Oscillator/Mod Level", fHslider1, 0.0f, 0.0f, 200.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("[1]Control/[1]Options/Spectrum Spread", fHslider9, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("[1]Control/[1]Options/Random Mod", fHslider10, 0.0f, 0.0f, 100.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("[1]Control/[1]Options/High Freq Position", fHslider5, 0.0f, 0.0f, 2.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("[1]Control/[1]Options/Pulse Level", fHslider0, 2.0f, 2.0f, 3.0f, 1.0f);
	FAUST_ADDVERTICALSLIDER("[1]Control/Gain", fVslider0, 50.0f, 0.0f, 100.0f, 0.10000000000000001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Sync, "[0]General/Sync", fHslider2, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(BUTTON, gate, "[0]General/gate", fButton0, 0.0, 0.0, 1.0, 1.0) \
		p(HORIZONTALSLIDER, freq, "[0]General/freq", fHslider7, 440.0f, 1.0f, 4000.0f, 1.0f) \
		p(HORIZONTALSLIDER, Bend, "[0]General/Bend", fHslider8, 0.0f, -12.0f, 12.0f, 0.01f) \
		p(HORIZONTALSLIDER, Pulse_Extend, "[1]Control/[0]Oscillator/Pulse Extend", fHslider3, 0.0f, 0.0f, 100.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, Pulse_Mode, "[1]Control/[0]Oscillator/Pulse Mode", fHslider4, 1.0f, 1.0f, 57.0f, 2.0f) \
		p(HORIZONTALSLIDER, Mod_Freq, "[1]Control/[0]Oscillator/Mod Freq", fHslider6, 0.0f, 0.0f, 100.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, Mod_Level, "[1]Control/[0]Oscillator/Mod Level", fHslider1, 0.0f, 0.0f, 200.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, Spectrum_Spread, "[1]Control/[1]Options/Spectrum Spread", fHslider9, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, Random_Mod, "[1]Control/[1]Options/Random Mod", fHslider10, 0.0f, 0.0f, 100.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, High_Freq_Position, "[1]Control/[1]Options/High Freq Position", fHslider5, 0.0f, 0.0f, 2.0f, 1.0f) \
		p(HORIZONTALSLIDER, Pulse_Level, "[1]Control/[1]Options/Pulse Level", fHslider0, 2.0f, 2.0f, 3.0f, 1.0f) \
		p(VERTICALSLIDER, Gain, "[1]Control/Gain", fVslider0, 50.0f, 0.0f, 100.0f, 0.10000000000000001f) \
...
template <typename FloatType>
void FaustPlugInAudioProcessor::process (juce::AudioBuffer<FloatType>& buffer, MidiBuffer& midiMessages)
{
    AVOIDDENORMALS;
